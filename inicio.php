        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarCenteredExample">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="envios.php">Envíos</a>
                    </li>
                    <div class="dropdown">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mb-md-0 text-start">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>
                                <a href="reporte_venta.php" class="text-white p1">Reporte de ventas </a>
                            </li>
                            <li>
                                <a href="reporte_post_venta.php" class="text-white p1">Reporte post venta</a>
                            </li>
                        </ul>
                    </div>
                    <!--Grid column-->
